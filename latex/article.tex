...
\unsure[inline]{Something on how log transform is reasonable. That differences are more important for small values of bilirubin than large.}
...
\change[inline]{Give English names to the covariates in the correlations figure}
%
\begin{figure}[h!tb]
    \begin{center}
